...
//        return reviews.stream().filter(review -> review.getBook().getId().equals(bookId)).collect(Collectors.toList());
//    }
//
//    @Override
//    public Review findReviewById(Integer bookId, Integer reviewId) {
//        return reviews.stream()
//                .filter(review -> review.getBook().getId().equals(bookId) && review.getId().equals(reviewId))
//                .findFirst().orElse(null);
//    }
//
//    @Override
//    public boolean deleteBookReview(Integer bookId, Integer reviewId) {
//        return reviews.removeIf(review -> review.getBook().getId().equals(bookId) && review.getId().equals(reviewId));
//    }
//
//    @Override
